 ...
 * @LastEditTime : 2020-12-04 14:50:54
 * @FilePath     : \DAPLink\source\algo\SWD_flash.c
 */
/**
 * @file    SWD_flash.c
...
error_t target_flash_init(uint32_t flash_start)
{
    ...
    if (0 == swd_flash_syscall_exec(&STM32_ALGO[Select_algo].algo.sys_call_s, STM32_ALGO[Select_algo].algo.init, flash_start, 0, 0, 0,0))
    {
        return ERROR_INIT;
    }
